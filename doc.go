...
If the `TryFn` return a nil error at any moment it will be considered a
successful execution and nil will be returned by the `With*` function.

To know more about the `ErrorGroup` go to
[https://github.com/nproc/errorgroup-go](https://github.com/nproc/errorgroup-go)
...
after the last execution. Because of this everytime the last interval is
